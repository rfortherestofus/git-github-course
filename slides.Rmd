...
1. If your default branch is called `master`, switch to main using `git_default_branch_rename()`
...
1. Working in your `local-first` repo on GitHub, create a new issue
...
1. Assign the issue you created in the last lesson to yourself
