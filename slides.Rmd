...
## With GitHub, Many People Can Work on the Same Project at Same Time
...
## Using GitHub Lets Us Combine Code and Communication About Our Code
...
## Drawback of GitHub: Sometimes Things Go Wrong
...
And then lets you decide which version to keep
...
Look for the conflict marker <<<<<<<

Look for the divider  =======

Look for the end conflict marker >>>>>>>
...
## Let's Keep Bad Things from Happening 
...
- You've got a working version in the main branch

- You want to test something out and only use it if it works
...
Talk about master vs main

Show how to change name of master to main: 
...
## How Do We Merge Our Work Back Into the Main Branch?

- Can't do this within RStudio
...
- GitLab calls them merge requests, which is a more descriptive name

---

### Pull Requests

Can package up a series of changes and allow someone else to review them before merging into main
...
Find branch you want to use for your pull request
...
### How to Deal with Someone Else's Pull Request
