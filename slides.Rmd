...
1. Confirm that you installed Git correctly by going to your terminal in RStudio and typing `git --version` (you should have version 2.33.0 or later)
...
1. Create a new R script file in your project and add some code in it
...
1. Check the staged button next to your new file (and any other modified files)

--

1. Add a commit message (e.g. "Add new data analysis file")
...
1. Hit the history button under the Git tab
...
### TODO: Show how you can view diff or code as it was at that point
...
1. Open the [API Community Food Asset Mapping Project GitHub repository](https://github.com/rfortherestofus/api-food-asset-map)
...
1. Open the project you created previously and which already has a **local** Git repository

--

1. Push your project to GitHub using the `use_github()` function from the `usethis` package
...
1. Create a new project in RStudio by cloning the GitHub repository you just created
...
1. Make some changes to any file in your local repository
